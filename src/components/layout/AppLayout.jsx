    ...
    <div className="min-h-screen bg-background font-inter">
      ...
      {showSwitch && (
        <div className="fixed inset-0 z-[100] flex items-end justify-center">
          ...
          <div className="relative w-full bg-background rounded-t-2xl p-6 space-y-4 max-h-[80vh] overflow-y-auto" style={{ paddingBottom: 'calc(4rem + env(safe-area-inset-bottom))' }}>
